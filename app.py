...
# ==========================================
# Banner
st.markdown(f"""<div class="banner-container"><img src="{BANNER_URL}" class="banner-img"></div>""", unsafe_allow_html=True)
st.markdown(f"""
