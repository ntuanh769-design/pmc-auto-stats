...
# Dữ liệu khởi tạo Voting (Giống hình)
INIT_VOTING_DATA = [
...
<style>
    ...
    .badge-plus { 
        ...
        padding: 4px 8px; border-radius: 12px; font-size: 13px; font-weight: bold; 
    }
    .badge-neutral { 
    ...
    /* FOOTER */
    .footer-container { 
        background: linear-gradient(180deg, #4A148C, #311B92); /* Tím đậm đồng bộ */
    ...
    .footer-bottom { 
        ...
        font-size: 12px; color: #B39DDB; text-align: center; 
    }
...
# Placeholder cho Footer (Sẽ render trong loop)
